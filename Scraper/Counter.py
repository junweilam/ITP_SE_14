...
from GlassDoorReviewCounter import GlassDoorReviewCounter
...
def main():
    ...
    review_worker = GlassDoorReviewCounter(company_code, company_name, account_number, batch_size)
    ...
    """Uncomment if you want to scrape number of reviews for multiple companies. (Provide this json file in FILE_PATH)"""
