...
class GlassDoorCompanyInformationWorker:
    ...
    def dump_dictionary_to_json(self, company_dictionary):    
        """Dumps dictionary to json file ..\data\Company Information\Company_information2"""
        ...
        destination_file = os.path.join(DESTINATION_DIRECTORY, f"Company_Information2.json")
